...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('medical-assistant.dashboard') }}" target="_blank">
            ...
            <span class="ms-1 font-weight-bold align-items-center">Medical Assistant</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'medical-assistant.dashboard' ? 'active' : '' }}" href="{{ route('medical-assistant.dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'sales.index' ? 'active' : '' }}" href="{{ route('sales.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Create New Order</span>
                </a>
            </li> 
            <li class="nav-item">
